...
export function PedidosContent() { // admin pode mais que employee
  ...
  const fetchOrders = async (page: number = 1) => {
    try {
      setLoading(true);
      const response: PaginatedOrdersResponse = await getAllOrders(
        page,
        PEDIDOS_CONFIG.limit,
      );
